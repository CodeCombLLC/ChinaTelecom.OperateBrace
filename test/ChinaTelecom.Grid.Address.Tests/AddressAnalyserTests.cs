...
using Xunit;
using ChinaTelecom.Grid.Address;

namespace ChinaTelecom.Grid.Address.Tests
{
    public class AddressAnalysisTests
    {
        [Theory]
        ...
        {
            // Act
            var result = Analysis.FilterBrackets(src);
        ...
        {
            // Act 1
            var result = Analysis.GetNumbers(src);
        ...
        {
            // Act
            var result = Analysis.GetLayer(src);
        ...
        {
            // Act
            var result = Analysis.GetDoor(Analysis.GetNumbers(src));
        ...
        {
            // Act
            var result = Analysis.GetUnit(src);
        ...
        {
            // Act
            var result = Analysis.GetBuildingNumber(src);
        ...
        {
            // Act
            var result = Analysis.GetCity(src);
        ...
        {
            // Act
            var result = Analysis.GetDistrict(src);
        ...
        {
            // Act
            var result = Analysis.GetEstate(src);
